...
<head>
  ...
  <title>Ajout membre équipe médicale</title>
...
<body>
  ...
  <br>
  <h1 align="center">Ajouter un nouveau membre de l'équipe médicale</h1>
  <div class="main">
   
    <form class="f1" method="POST" action="./ajoutStaffBD.php">
      <table>
        <tr>
          <td>
            <h2>Obligatoire : </h2>
